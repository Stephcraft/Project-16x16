...
Welcome to project 16x16! If you are new to the GitHub and open source world, we recommend you to take a look at this [10 minute read introduction](https://guides.github.com/activities/hello-world/).
...
5. To clone the project, execute ```git clone https://github.com/your-github-username/Project-16x16/``` a valid url could be: ```https://github.com/Noodleman123/Project-16x16/```
...
| Select your fork of **Project-16x16**,<br> navigate to where you want the<br> project to be cloned and **Clone** | <img src="https://i.imgur.com/5rx8vvr.png" width="400"/> |
