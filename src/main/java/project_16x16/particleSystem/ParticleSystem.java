...
import project_16x16.particleSystem.emissions.ParticleEmission;
import project_16x16.particleSystem.events.ParticleEventListener;

/**
 * Particle System
 * <p>
 * To create a custom emission {@link ParticleEmission} can the position,
 * velocity and acceleration for each particle. To create a custom Controller
 * {@link ParticleEventListener} can control almost any part of the particle.
 *
 * @author petturtle
 */
public class ParticleSystem {
	...
	private ArrayList<ParticleEventListener> listeners = new ArrayList<>();
	...
	/**
	 * Create a new particle system. Set emission with setEmission() for a different
	 * effect, default provided
	 * 
	...
	public ParticleEmission getEmission() {
		return emission;
	}
