	...
	public void updateEdit() {
		...
		if (focus) { // When Focused
			...
			if (focus && applet.mousePressed && applet.mouseButton == LEFT) {
				pos = new PVector(
						Utility.roundToNearest(applet.getMouseCoordGame().x + editOffset.x, Main.snapSize),
						Utility.roundToNearest(applet.getMouseCoordGame().y + editOffset.y, Main.snapSize));
			}
		}
	}
