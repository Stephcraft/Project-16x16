...
public class Player extends EditableObject {
	...
	public void update() {
		...
		pflying = flying;
		prevKey = applet.key;
//		applet.println(TOP, LEFT, SHIFT, prevKey);
 ...
 * 
 * if(py-applet.originY+height/2 < collision.pos.y-applet.originY) {
 * //if(!(speedY < 0 && flying)) { //pos.y = collision.pos.y-collision.height/2
 * - height/2; //} //speedY = 0; //flying = false; } else if(py-applet.originY >
 * collision.pos.y-applet.originY) { //pos.y =
 * collision.pos.y+collision.height/2 + height/2;
 * 
 ...
 * //pos.y = collision.pos.y-collision.height/2 - height/2; //speedX = 0;
 * //flying = false; //speedY = 0; }
 * 
 * else if(py-applet.originY > collision.pos.y-applet.originY) { pos.y =
 * collision.pos.y+collision.height/2 + height/2; }
 * 
 * else if(pos.y-applet.originY > collision.pos.y-applet.originY) { //pos.y =
 * collision.pos.y+collision.height/2 + height/2;
 * 
 * }
 * 
 * //if(!collidesFutur(collision)) { // flying = true; //}
 * 
 */
