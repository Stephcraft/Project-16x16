...
import game.objects.MagicSourceObject;
import game.objects.MirrorBoxObject;
...
public class Tileset {
	 ...
	 * loading level info from JSON (ie. constructing Java game.objects -- map game.objects --
