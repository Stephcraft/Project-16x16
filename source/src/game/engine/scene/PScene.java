...
public abstract class PScene extends PClass {
	...
	/**
	 * Keep track of whether the game.engine.scene has ever registered methods with PApplet --
	...
	/**
	 * Called when game.engine.scene is made active (set-up). If you @Override this method,
	...
	/**
	 * Called when the game.engine.scene was active but another game.engine.scene made active (tidy-up). If
